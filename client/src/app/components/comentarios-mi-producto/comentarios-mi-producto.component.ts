...
@Component({
  selector: 'app-comentarios-mi-producto',
  templateUrl: './comentarios-mi-producto.component.html',
  styleUrls: ['./comentarios-mi-producto.component.css']
})
export class ComentariosMiProductoComponent implements OnInit {
